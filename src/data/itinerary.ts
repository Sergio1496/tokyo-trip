...
export const days: DayData[] = [
  ...
  // ============ DIA 9 ============
  {
    ...
    timeSlots: [
      ...
      },
      {
        ...
        timeRange: "23:30+",
        activities: [
          a("Shibuya a Akihabara (~30 min). Salir antes de las 23:00", { transit: [{ from: "Shibuya", to: "Akihabara", line: "JR Yamanote" }] }),
          nuevo("Meeting point 23:30 - FujiSoft Akihabara (frente al Family Mart)", { cat: 'attraction',
            description: "Recogida para ir al car meet de Daikoku PA. Dirección: 3 Kanda Neribeicho, Chiyoda City (estación Akihabara). https://maps.app.goo.gl/3sMNsTfnVFxPsdpu6",
            tips: [
              "Confirmar punto exacto y hora con quien recoge",
              "El último JR Yamanote desde Shibuya hacia Akihabara es ~24:00, ir con margen",
              "Daikoku se alarga hasta madrugada/amanecer del domingo - el día 10 (Kawagoe) puede ir muy flojo, valorar moverlo o hacerlo light",
            ],
          }),
          nuevo("Daikoku Parking Area - car meet", { cat: 'attraction', description: "Punto mítico de coches en la bahía de Yokohama (JDM, modificados, importados). Solo accesible por coche, vía autopista" }),
        ],
      },
    ],
  },
  ...
  // ============ DIA 12 ============
  {
    ...
    weekday: "Martes",
    title: "Tsukiji + amiga",
    subtitle: "Mañana en Tsukiji, comida con amiga y tarde improvisada con ella.",
    area: "Ginza / Tsukiji",
    route: [
      { from: "Ukima-Funado", to: "Akabane", line: "JR Saikyo", duration: "3 min" },
    ...
    timeSlots: [
      ...
      {
        label: "Mediodía / Tarde",
        icon: "sunset",
        timeRange: "12:00 - 18:00",
        activities: [
          a("Comida con amiga (sitio y zona a coordinar con ella)"),
          a("Tarde improvisada con la amiga - sin plan fijo"),
          a("Por si hace falta inspiración: Ginza Six (azotea con jardín), Uniqlo flagship Ginza (12 pisos), paseo por la calle principal, o saltar a Monzen-nakacho a Tonkatsu Marushichi", { description: "Solo como ideas de respaldo" }),
        ],
      },
      {
        label: "Noche (a coordinar con amiga)",
        icon: "moon",
        timeRange: "18:00+",
        activities: [
          a("Cena depende de cómo vaya la tarde con ella"),
          saved("Ginza Yakitori Kato", { cat: 'food', description: "Opción: yakitori premium en Ginza" }),
          saved("Yakiniku Inoue Ginza", { cat: 'food', description: "Opción: carne a la parrilla" }),
          saved("Sushi Shiogamako Ginza Kiwami", { cat: 'food', description: "Opción: sushi de calidad" }),
        ],
      },
    ],
  },
  ...
  // ============ DIA 14 ============
  {
    ...
    subtitle: "Tren a Kawaguchiko. Salida 10:30, vuelta 17:41. ⚠️ Recoger billetes ANTES en JR Shinjuku/JR East.",
    area: "Fujikawaguchiko",
    route: [
      { from: "Ukima-Funado", to: "Shinjuku", line: "JR Saikyo", duration: "25 min" },
      { from: "Shinjuku", to: "Kawaguchiko", line: "Tren reservado (JR + Fujikyu)", duration: "~2h", cost: "billete reservado" },
    ],
    returnRoute: [
      { from: "Kawaguchiko", to: "Shinjuku", line: "Tren reservado (JR + Fujikyu)", duration: "~2h", cost: "billete reservado" },
      { from: "Shinjuku", to: "Ukima-Funado", line: "JR Saikyo", duration: "19 min" },
    ],
    timeSlots: [
      {
        label: "⚠️ Antes del viaje",
        icon: "sun",
        timeRange: "Algún día anterior",
        activities: [
          nuevo("RECOGER BILLETES CON ANTELACIÓN", { cat: 'attraction',
            description: "NO se pueden recoger billetes físicos en estaciones del Monte Fuji (Shimoyoshida, Fuji-san, Fuji-Q Highland, Kawaguchiko). Hay que recogerlos en JR Shinjuku o cualquier estación JR East de Tokyo ANTES del día 14",
            tips: [
              "Aprovechar un día previo cerca de Shinjuku (p.ej. día 8, 9 o 13) para pasar por la taquilla y recogerlos",
              "Llevar la confirmación de reserva y pasaporte",
            ],
          }),
        ],
      },
      {
        label: "Día completo",
        icon: "sun",
        timeRange: "10:30 - 17:41",
        activities: [
          a("Salida 10:30 desde Shinjuku hacia Kawaguchiko (~2h)", { tips: ["Llegar a Shinjuku con 15-20 min de margen", "Llevar comida/snacks del konbini, en Kawaguchiko es más caro"] }),
          ...
          nuevo("Oshino Hakkai", { cat: 'attraction', cost: "GRATIS (algunas pozas 300 yen)", description: "Pueblo con pozas cristalinas alimentadas por el Fuji" }),
          a("⚠️ Tren de vuelta sale a las 17:41 desde Kawaguchiko - estar en estación 15 min antes"),
        ],
      },
      {
        label: "Vuelta",
        ...
        timeRange: "17:41+",
        activities: [
          a("Tren Kawaguchiko -> Shinjuku (~2h)"),
          a("Cenar por el camino en Shinjuku o en casa"),
        ],
      },
    ],
  ...
  // ============ DIA 15 ============
  {
    ...
    date: "15 de Mayo",
    weekday: "Viernes",
    title: "Día libre - Centro de Tokyo",
    subtitle: "Último día completo. Sin plan fijo, lo que apetezca por el centro.",
    area: "Centro de Tokyo",
    route: [
      { from: "Ukima-Funado", to: "Shinjuku", line: "JR Saikyo", duration: "25 min" },
    ],
    returnRoute: [
    ...
    timeSlots: [
      {
        ...
        activities: [
          a("Sin plan fijo - revisitar zonas favoritas o cerrar pendientes (compras, fotos, cafés)"),
          a("Si falta inspiración, ver la sección de opciones de abajo"),
        ],
      },
      {
        label: "Noche",
